    ...
    <div className="relative w-44 h-44 flex items-center justify-center">
      ...
      {[...Array(3)].map((_, i) => (
        <motion.div
          ...
          animate={{ opacity: [0, 0.25, 0], scale: [0.8, 1.6] }}
      ...
      <svg className="absolute inset-0 w-full h-full -rotate-90">
        <circle cx="88" cy="88" r="78" fill="transparent" stroke="rgba(255,255,255,0.08)" strokeWidth="4" />
        ...
        <motion.circle
          ...
          strokeLinecap="round"
          strokeDasharray="490"
          animate={{ strokeDashoffset: [490, 0] }}
