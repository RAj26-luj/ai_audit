...
type Props = { setStep: React.Dispatch<React.SetStateAction<StepType>> };

//navbar
export default function Navbar({ setStep }: Props) {
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-20 flex items-center justify-between">
        ...
        <div className="md:hidden">
          <MobileMenuButton open={menuOpen} toggle={() => setMenuOpen(!menuOpen)} />
        </div>
