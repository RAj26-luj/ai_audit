...
export default function HeroSection({
  ...
  const handleStartAudit = () => {
    localStorage.setItem("selectedFeature", "audit");
    setStep("inputs");
  };
  ...
  return (
    <motion.div style={{ rotateX, rotateY }} className="relative z-10 flex flex-col items-center text-center max-w-5xl">
      ...
      <h1 className="text-6xl md:text-8xl font-black tracking-tighter leading-[0.9] text-white">
        Audit Your AI Stack<br />Recover Your Burn.
      </h1>

      {/* subtitle */}
      <p className="text-xl text-gray-400 mt-8 max-w-2xl leading-relaxed">
        Most startups waste 30% of their AI budget on unused seats, overlapping subscriptions, and inefficient pricing plans.
      </p>
